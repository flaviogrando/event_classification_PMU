...
% % Diretório: 
dir_dados = 'C:\Users\Flavio\Google Drive\MATLAB\FINAIS\Dados\Eventos\DFT\';
%dir_modelos = 'G:\DADOS\Modelos\42_DFT\';
dir_resultados = 'G:\DADOS\Resultados\42_DFT_varTVE\';
...
%erro = [0 0.025 0.05 0.1 0.25 0.5 0.75 1 2 3];  % TVE
erro = [1.5 2.5];
% erro = [5];
