...
function [entradas, saidas, labels] = features_extraction(diretorio, dados, grupo, f, col)
%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
%[D] = diferenca_pre_pos_freq(matriz_entrada, f);
...
switch grupo % SELECIONA GRUPO DE CARACTERÍSTICAS
   ...
   % I
    ...
    case 42
        entradas = [D.MT1 D.MT4 D.MC1 D.MC4 D.AT1 D.AT4 D.AC1 D.AC4];
