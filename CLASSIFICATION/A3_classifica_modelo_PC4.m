...
dir_dados = 'C:\Users\Flavio_CPGEI\Google Drive\MATLAB\FINAIS\Dados\Eventos\DFT_60dB\';
dir_modelo = 'C:\MEGAsync\DADOS\Modelos\DFT_60dB_k2\';
dir_resultado = 'C:\MEGAsync\DADOS\Resultados\DFT_k2_desTVE';
...
for e=1:length(erro)
    for f=1:length(freqs) % varre parâmetros
        for cl=2
            ...
            [entradas,saidas,labels] = features_extraction_desFE(dir_dados,dados,tipo,freqs(f),col(cl),erro(e),k(1)); 
